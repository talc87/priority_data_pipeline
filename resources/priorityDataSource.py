...
class priorityDataSource:
    ...
    def refreshData(self,incremental:bool)->dict:
        ...
        for i in self.entities:
            ...
            #parsing the data entity json to multiple pandas df. getting a list of dict {entityName: <entityName>, df: <pandas df>}
    ...
    def entityGetRequest(self,entity:dict, incrementalFlag:bool = True):
        ...
        if entity['filterFlag']:        #filterFlag = True
    ...
    def parsingDf(self,data:dict,entityId: str)->list:
        ...
        for i in entitySubforms:
            ...
            if not subformDF.empty:
                ...
                subformDF['requestTimestampUTC']=pd.to_datetime('now', utc=True)
                subformDF['extractionID']=self.extractionID
                
                dict = {
                            'tableName': i
                            ,'entityName': i + "_SUBFORM"
                            ,'df': subformDF}
                dfList.append(dict)
